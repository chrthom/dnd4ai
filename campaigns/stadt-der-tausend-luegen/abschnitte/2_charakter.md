...
Halte dich bzgl. der Optionen, Fragen und dem Ablauf der Charaktererstellung an die Detailinformationen in engine/regeln/charakter.json.
...
2. Rufe einen Spieler nach dem anderen auf und führe ihn durch diese Schritte der Charaktererstellung (Ablauf, Schritte, Fragen und Optionen in engine/regeln/charakter.json)
...
Wenn alle Spieler einen Charakterbogen erstellt haben, überschreibe temp/$CAMPAIGN/status.txt und trage "3_archive" ein. Fahre mit den Anweisungen in campaigns/$CAMPAIGN/abschnitte/3_archive.md fort.
