...
## Discord-Nachrichten Stil im Tempo-Modus

Nachrichten sind kürzer, drängender, mit mehr Ausrufezeichen und Imperativen:

```
*Die Schritte werden lauter – noch zehn Sekunden, dann sind die Wachen hier!*

**Gruppe:** Jetzt entscheiden – **Tür eintreten** oder **durch das Fenster**?
```

Kein langer Fließtext. Jeder Block max. 3-4 Sätze. Spannung vor Atmosphäre.
